-- Migration 035: validar faixa etária por ano de nascimento (ano calendário)
-- Regra: se o atleta completa a idade mínima/máxima no ano corrente, ele é elegível.
