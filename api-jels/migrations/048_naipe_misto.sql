-- Migration 046: Adiciona naipe MISTO (X) e ajusta trigger para permitir
-- alunos M e F em modalidades mistas.

-- 1. Inserir o naipe MISTO
INSERT INTO naipes (codigo, nome)
VALUES ('X', 'MISTO')
ON CONFLICT (codigo) DO NOTHING;

-- 2. Recriar o trigger validar_estudante_equipe com suporte a naipe MISTO
