-- Migration 022: Reaplicar regra - cada aluno pode participar de no máximo
-- 1 modalidade Individual e 1 modalidade Coletiva.
-- Garante que a função validar_estudante_equipe (trigger em equipe_estudantes) contenha esta validação.
