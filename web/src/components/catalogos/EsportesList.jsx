        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 flex-1 min-w-0">
          <div className="flex items-center justify-between px-3 sm:px-5 py-4 sm:py-5 bg-white rounded-[12px] border border-[#f1f5f9] shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
            <div className="flex-1 overflow-hidden pr-2">
              <p className="text-[10px] sm:text-[0.875rem] text-[#64748b] m-0 mb-0.5 sm:mb-1 uppercase font-bold tracking-wider truncate w-full" title="Variantes">
                Variantes
              </p>
              <p className="text-[1.125rem] sm:text-[1.5rem] font-extrabold text-[#042f2e] m-0">{filteredVariantes.length}</p>
            </div>
            <div className="shrink-0 p-1.5 sm:p-3 bg-[#f0fdfa] rounded-lg sm:rounded-xl">
              <Trophy className="w-5 h-5 sm:w-7 sm:h-7 text-[#0f766e]" />
            </div>
          </div>
          <div className="flex items-center justify-between px-3 sm:px-5 py-4 sm:py-5 bg-white rounded-[12px] border border-[#f1f5f9] shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
            <div className="flex-1 overflow-hidden pr-2">
              <p className="text-[10px] sm:text-[0.875rem] text-[#64748b] m-0 mb-0.5 sm:mb-1 uppercase font-bold tracking-wider truncate w-full" title="Esportes">
                Esportes
              </p>
              <p className="text-[1.125rem] sm:text-[1.5rem] font-extrabold text-[#042f2e] m-0">{totalEsportes}</p>
            </div>
            <div className="shrink-0 p-1.5 sm:p-3 bg-[#f0fdfa] rounded-lg sm:rounded-xl">
              <Trophy className="w-5 h-5 sm:w-7 sm:h-7 text-[#0f766e]" />
            </div>
