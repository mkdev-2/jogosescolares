  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          <HeroSection />
          <div className="relative bg-[#f0fdf4] bg-gradient-to-b from-emerald-50/50 via-white to-emerald-50/30 pt-6 pb-12 overflow-hidden border-y border-emerald-100/50 shadow-[inner_0_2px_10px_rgba(16,185,129,0.05)]">
