...
import SorteioGruposAoVivo from '../components/campeonato/SorteioGruposAoVivo'
  ...
  return (
    <div className="flex flex-col gap-6 p-6 max-w-7xl mx-auto">
      ...
      {etapa === 'sorteio' && estrutura && (
        <SorteioGruposAoVivo equipes={equipesSorteio} estrutura={estrutura} onSalvar={handleSalvar} salvando={salvando} />
      )}
